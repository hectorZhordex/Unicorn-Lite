  ...
  return (
    ...
    >
            ...
            >
              <div className="flex flex-col gap-2">
                <Link
                  ...
                  className="flex items-center justify-center gap-1.5 w-full px-3 py-2.5 rounded-xl text-sm font-semibold text-white transition-all whitespace-nowrap"
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 w-full px-3 py-2.5 rounded-xl text-sm font-semibold text-white transition-all whitespace-nowrap"
                  style={{ background: "linear-gradient(135deg, #7c3aed, #3b82f6)", boxShadow: "0 4px 15px rgba(124,58,237,0.5)" }}
                >
                  <Lock size={14} />
                  Unlock Download
                </button>
      ...
      <div className="p-5">
        ...
        {/* Category */}
        {artwork.category && (
          <span className="inline-block text-xs px-3 py-1.5 rounded-full mb-3"
